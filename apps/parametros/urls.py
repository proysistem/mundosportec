...
from apps.parametros.views import SucLista, SucNuevo, SucView, SucEdita, SucDelet, ZipLista, ZipNuevo, ZipView, ZipEdita, ZipDelet, PaiLista, PaiNuevo, PaiView, PaiEdita, PaiDelet, PviLista, PviNuevo, PviView, PviEdita, PviDelet, CiuLista, CiuNuevo, CiuView, CiuEdita, CiuDelet
...
#    url(r'^PrcPanel',                  PrcLista.as_view(), name='prc_panel'),
#    url(r'^PrcNuevo/$',                PrcNuevo.as_view(), name='prc_new'),
#    url(r'^PrcConsulta/(?P<pk>\d+)/$', PrcView.as_view(),  name='prc_view'),
#    url(r'^PrcEdita/(?P<pk>\d+)/$',    PrcEdita.as_view(), name='prc_edit'),
#    url(r'^PrcElimina/(?P<pk>\d+)/$',  PrcDelet.as_view(), name='prc_delet'),
