...
class Controlador(models.Model):
    ...
    ctl_secue05 = models.PositiveIntegerField('Secuencia 05 Nota/Crédito', null=True, blank=True)
    ctl_secue06 = models.PositiveIntegerField('Secuencia 06 Nota/Débito', null=True, blank=True)
