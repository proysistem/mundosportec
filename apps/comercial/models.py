...
from apps.inventarios.models import Producto, Existencia, Unidad
...
class Cliente(models.Model):
	...
	clt_telefon = models.CharField('Telefono', max_length=15)
	clt_celular = models.CharField('Celular', max_length=15)
	clt_correoe = models.EmailField('e-mail')
	clt_imgclte = models.ImageField(upload_to = "clientes")
	clt_rgunico = models.IntegerField('Registro Unico')
...
class Vendedor(models.Model):	
 	...
 	vnd_telefon = models.CharField('Telefono', max_length=15)
 	vnd_ncelula = models.CharField('Celular', max_length=15)
 	vnd_correoe = models.EmailField('e-mail')
 	vnd_addrimg = models.CharField('Direccion de la foto', max_length=75)
 	vnd_rgunico = models.IntegerField('Registro Unico')
